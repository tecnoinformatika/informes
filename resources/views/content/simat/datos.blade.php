    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Importar archivo del SIMAT en Excel</h4>
        </div>
        <div class="card-body">
          <p class="card-text">
          ...
          <form action="{{ route('simat-importar') }}"   method="post" enctype="multipart/form-data">
            @method("POST")
            @csrf
            <div class="mb-1">
              <label for="customFile1" class="form-label">Archivo excel del simat</label>
              <input class="form-control" type="file" id="customFile1" required="require" name="excelsimat">
