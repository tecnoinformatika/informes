  ...
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      ...
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('app/calendar') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Calendario"><i class="ficon"
            data-feather="calendar"></i></a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('app/todo') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Actas de visita"><i class="ficon"
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
      ...
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        <li class="dropdown-menu-header">
          <div class="dropdown-header d-flex">
            ...
            <div class="badge rounded-pill badge-light-primary">1 Nueva</div>
          </div>
        </li>
        <li class="scrollable-container media-list">
        ...
        <li class="dropdown-menu-footer">
          <a class="btn btn-primary w-100" href="javascript:void(0)">ver todas</a>
        </li>
      </ul>
    </li>
    <li class="nav-item dropdown dropdown-user">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        <h6 class="dropdown-header">Adminstrar datos</h6>
